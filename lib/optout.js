...
// nas últimas JANELA_HORAS horas, e VOLTAR só nas JANELA_HORAS horas depois de o cliente ter
// saído (funciona como "desfazer" para quem saiu por engano).
const JANELA_HORAS = 24;

const MSG_SAIDA_CONFIRMADA = `Tudo bem, você não vai mais receber mensagens promocionais da gente. Se foi engano, responda VOLTAR nas próximas ${JANELA_HORAS} horas.`;
...
module.exports = {
  ...
  RODAPE_OPTOUT, MSG_SAIDA_CONFIRMADA, MSG_VOLTA_CONFIRMADA, JANELA_HORAS,
};
