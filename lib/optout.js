...
const MSG_SAIDA_CONFIRMADA = "Tudo bem, você não vai mais receber mensagens promocionais da gente. Se mudar de ideia, é só responder VOLTAR.";
...
module.exports = {
  ...
  RODAPE_OPTOUT, MSG_SAIDA_CONFIRMADA, MSG_VOLTA_CONFIRMADA,
};
