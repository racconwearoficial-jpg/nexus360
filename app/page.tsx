...
const RECURSOS = [
  ...
  { t: "WhatsApp automatizado (Crescimento)", d: "Seu WhatsApp passa a trabalhar sozinho: dispara a mensagem certa, com foto, pro cliente certo — sem você tocar no celular" },
];
...
const PACOTES = [
  ...
  },
  {
    ...
    itens: ["Sistema Nexus 360 completo, com sua base cadastrada", "WhatsApp que trabalha sozinho: mensagem certa, com foto, pro cliente certo — sem você tocar no celular", "Google atualizado toda semana", "Avaliações trabalhadas e respondidas", "12 artes por mês com legendas", "Uma campanha de reativação por mês", "Relatório mensal do seu Google: visualizações, cliques e pedidos de rota"],
